...
class TestCompareWaveforms(unittest.TestCase):
    ...
    def path_layout(self, folder, design_a, design_b, top):
    ...
    def test_1(self):
        ...
        path = self.path_layout("alu_test", "alu_impl.v", "alu_reversed.v", "alu")
    ...
    def test_2(self):
        ...
        path = self.path_layout(
            "corrupt_alu_test", "alu_impl.v", "alu_reversed.v", "alu"
        )
        self.refresh_directory(path)
        compare_waveforms.generate_files(path, 100, 0, False)
    ...
    def test_3(self):
        ...
        path = self.path_layout("calc_test", "calc_impl.v", "calc_reversed.v", "calc")
        self.refresh_directory(path)
        compare_waveforms.generate_files(path, 100, 0, False)
        self.assertEqual(compare_waveforms.run_test(path), True)
    ...
    def test_6(self):
        ...
        shutil.move(
            f"{package}/temp/alu_impl.vcd", f"{path['build_dir']}/alu_reversed.vcd"
        )
