...
def parse(file):
    ...
    logging.info(f"Parsed Input IOs {data['input_list']} with respective bit sizes {data['input_bits_list']}")
    logging.info(f"Parsed Output IOs {data['output_list']} with respective bit sizes {data['output_bits_list']}")
    return data
